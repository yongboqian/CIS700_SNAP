...
if("FALSE" STREQUAL "TRUE")
  set(arbotix_python_SOURCE_PREFIX /home/nstiurca/codes/snap/catkin_ws/src/arbotix_ros/arbotix_python)
  set(arbotix_python_DEVEL_PREFIX /home/nstiurca/codes/snap/catkin_ws/src/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arbotix_python' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Michael Ferguson <mike@vanadiumlabs.com>' to fix it.")
    endif()
